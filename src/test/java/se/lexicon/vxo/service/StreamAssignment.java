...
public class StreamAssignment {
    ...
    public void task6(){
        ...
        result = people.stream().filter(person -> person.getFirstName().equalsIgnoreCase("Erik")).toArray(p->new Person[p]);
    ...
    public void task9(){
        ...
        dtoList = people.stream().filter(person -> person.getDateOfBirth().isBefore(LocalDate.parse("1920-01-01")))
    ...
    public void task10(){
        ...
        //Write code here
        optional = Optional.of(people.stream().filter(person -> person.getPersonId() == personId).findFirst().get().getDateOfBirth().format(DateTimeFormatter.ofPattern("eeee dd MMMM YYYY")).toUpperCase());
        assertNotNull(optional);
        assertTrue(optional.isPresent());
        assertEquals(expected, optional.get());
    }
    ...
    public void task11(){
        ...
        averageAge = people.stream().mapToInt( person -> personToAge.applyAsInt(person))
                .average().getAsDouble();
    ...
    public void task12(){
        ...
        result = people.stream().filter(person -> person.getFirstName().equalsIgnoreCase(String.valueOf(new StringBuilder(person.getFirstName()).reverse())))
    ...
    public void task14(){
        ...
        _2020_dates = Stream.iterate(LocalDate.ofYearDay(2020,1),
                localDate -> localDate.plusDays(1)).limit(366).toArray(LocalDate[]::new);
